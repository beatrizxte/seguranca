...
<div class="container">
  ...
  <div class="form-group">
    ...
    <div class="form-group">
      ...
      <input type="password" class="form-control" id="celular" placeholder="Senha" name="senha">
    </div>

    <div class="form-group">
      <label for="endereço">Endereço:</label>
      <input type="password" class="form-control" id="endereco" placeholder="Endereço" name="endereco">
    </div>
